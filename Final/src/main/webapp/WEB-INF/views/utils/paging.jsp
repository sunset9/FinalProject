...
<nav>
  <ul class="pagination">
  	...
  	<li>
      <a href="/mypage/preferartist?curPage=${paging.curPage-1 }"
       aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    ...
    <li><sapn>${paging.curPage }/${paging.endPage }</sapn></li>
    ...
    <!-- 다음 페이지 -->
  	...
  	<li class="disabled">
      <a href="/mypage/preferartist?curPage=${paging.totalPage }"
       aria-label="Next">
