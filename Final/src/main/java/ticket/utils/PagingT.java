...
public class PagingT {
	...
	//	pageCount == 10
	//	listCount == 10
	public PagingT(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	listCount == 10
	public PagingT(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	//	listCount == 10
	public PagingT(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
