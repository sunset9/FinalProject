	...
	<div class="tx_trex_container">
		<form action="/admin/faqwrite" method="post"
			...
			<table>
				...
				<tr>
					<td>분류</td>
					<td><input type="text" name="FTypeIdx"></td>
				</tr>
				<tr>
					<td>제목</td>
			...
			<jsp:include page="/WEB-INF/views/admin/notice/editor_frame.jsp"></jsp:include>
				...
				<textarea name="faqAnswer" id="faqAnswer" rows="10"
						cols="100" style="width: 766px; height: 412px; display:none"></textarea>
			

			<input type="button" id="save_button" value="내용전송" />
			<a href="http://localhost:8088/admin/faqlist"><button type="button" id="btnCancel">취소</button></a>
		</form>
	</div>
