...
<div role="tabpanel" class="contain">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#findEmail" aria-controls="findEmail" role="tab" data-toggle="tab">이메일 찾기</a></li>
    <li role="presentation"><a href="#findPass" aria-controls="findPass" role="tab" data-toggle="tab">비밀번호 찾기</a></li>
  </ul>

  <!-- Tab panes -->
  <div class="tab-content"  class ="form-inline">
    <div role="tabpanel" class="tab-pane active" id="findEmail">
