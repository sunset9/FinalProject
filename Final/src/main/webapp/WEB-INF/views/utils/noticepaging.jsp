...
<nav>
  <ul class="pagination">
      ...
      <a href="/admin/noticelist?curPage=${prevPage }"
       aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    ...
    <c:forEach begin="${paging.startPage }"
    	...
    	<c:if test="${paging.curPage eq page }">
	   	<li class="active">
	   		<a href="/admin/noticelist?curPage=${page }">${page }</a>
	   	</li>
	   	</c:if>
    ...
    <!-- 다음 페이지 -->
  	...
  	<li class="disabled">
      <a href="/admin/noticelist?curPage=${paging.totalPage }"
       aria-label="Next">
    ...
    <fmt:parseNumber var="n" integerOnly="true" value="${(paging.curPage/paging.pageCount)}"/>
  	...
  	<li>
      <a href="/admin/noticelist?curPage=${nextPage }"
       aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
