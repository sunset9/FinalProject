...
$(document).ready(function(){
	...
	$('#inqContents td textarea').froalaEditor('html.set', '${inqAns.contents }');
});
</script>

<div class="contents-wrapper">
<h1> 1:1 문의 답변 수정하기</h1>

<form action="/admin/editreplyinquiry" method="post">

<input type="hidden" name="userIdx" value="${loginUser.userIdx }"/>
<input type="hidden" name="inqIdx" value="${inqAns.inqIdx }"/>
<table id="detailTable" class="table" >	
<tr>
	<th>제목</th>
	<td><input type="text" name="title" class="form-control" value="${inqAns.title }"></td>
</tr>
<tr>
	<th>관리자이름</th>
